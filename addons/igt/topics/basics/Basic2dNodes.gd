...
func _init():
	super("2D sprites en camera's", [
		...
		TutorialStep.new("2D view schuiven", 
			...
			null, Callable(),
			"Panel:0/VBoxContainer:0/HSplitContainer:0/HSplitContainer:0/HSplitContainer:0/VBoxContainer:0/VSplitContainer:0/VSplitContainer:0/VBoxContainer:0/PanelContainer:1/VBoxContainer:0/CanvasItemEditor:0/HFlowContainer:0/HBoxContainer:0/Button:6", true),
		TutorialStep.new("2D view in/uitzoomen", 
			...
			null, Callable(),
			"Panel:0/VBoxContainer:0/HSplitContainer:0/HSplitContainer:0/HSplitContainer:0/VBoxContainer:0/VSplitContainer:0/VSplitContainer:0/VBoxContainer:0/PanelContainer:1/VBoxContainer:0/CanvasItemEditor:0/VSplitContainer:0/HSplitContainer:0/HSplitContainer:0/Control:0/CanvasItemEditorViewport:0/VBoxContainer:0/HBoxContainer:0/EditorZoomWidget:0/Button:1", true),
		...
		TutorialStep.new("Camera2D limieten testen", 
			"Start het spel nog eens.\n\nBeweeg naar boven en onder, en merk dat de camera stopt met volgen als je te ver naar onder gaat. Zo kan je zorgen dat het einde van de achtergrond nooit in beeld komt.",
			null, Callable(),
			"Panel:0/VBoxContainer:0/EditorTitleBar:0/EditorRunBar:0/PanelContainer:0/HBoxContainer:0/Button:0", true),
