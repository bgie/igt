...
func _init():
	super("Knopen en scenes", [
		...
		TutorialStep.new("Wat is een knoop?", 
			"Knopen (nodes) zijn de bouwstenen van je spel.\n\nEr zijn knopen voor afbeeldingen, animaties, geluid, user interfaces, fysica, A.I..."),
		...
		TutorialStep.new("Naar selecteer modus gaan", 
			...
			null, Callable(),
			"Panel:0/VBoxContainer:0/HSplitContainer:0/HSplitContainer:0/HSplitContainer:0/VBoxContainer:0/VSplitContainer:0/VSplitContainer:0/VBoxContainer:0/PanelContainer:0/VBoxContainer:0/CanvasItemEditor:0/MarginContainer:0/HFlowContainer:0/HBoxContainer:0/Button:0", true),
		...
		TutorialStep.new("Een scene opslaan (2)", 
			...
			null, Callable(),
			"Panel:0/EditorFileDialog:2/VBoxContainer:0/HSplitContainer:0/HSplitContainer:0/VBoxContainer:0/HBoxContainer:1/LineEdit:0", true,
			_scene_saved),
		...
		TutorialStep.new("Root node voor de tweede scene kiezen", 
			"Nu moeten we opnieuw een root node (de eerst knoop) kiezen.\n\nKies nogmaals 'Gebruikersomgeving' (User Interface).",
			null, Callable(),
			"Panel:0/VBoxContainer:0/HSplitContainer:0/HSplitContainer:0/VSplitContainer:0/TabContainer:0/SceneTreeDock:0/VBoxContainer:0/ScrollContainer:0/VBoxContainer:0/VBoxContainer:0/Button:2", true,
			_has_user_select_control_as_root),
		TutorialStep.new("Een scene in een scene (1)", 
			...
			null, Callable(),
			"Panel:0/VBoxContainer:0/HSplitContainer:0/HSplitContainer:0/VSplitContainer:0/TabContainer:1/FileSystemDock:0/SplitContainer:0/Tree:0", true,
		...
		TutorialStep.new("Wisselen tussen scenes",
			...
			null, Callable(),
			"Panel:0/VBoxContainer:0/HSplitContainer:0/HSplitContainer:0/HSplitContainer:0/VBoxContainer:0/VSplitContainer:0/VSplitContainer:0/VBoxContainer:0/EditorSceneTabs:0/PanelContainer:0/HBoxContainer:0/TabBar:0", true,
		...
		TutorialStep.new("Geneste scene wijzigen (2)",
			...
			null, Callable(),
			"Panel:0/VBoxContainer:0/HSplitContainer:0/HSplitContainer:0/HSplitContainer:0/VBoxContainer:0/VSplitContainer:0/VSplitContainer:0/VBoxContainer:0/EditorSceneTabs:0/PanelContainer:0/HBoxContainer:0/TabBar:0", false),
