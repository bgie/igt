...
func _init():
	super("Knopen en scenes", [
		...
		TutorialStep.new("Oefening knopen maken (2)", 
			...
			Callable(), "Panel:0/VBoxContainer:0/HSplitContainer:0/HSplitContainer:0/VSplitContainer:0/TabContainer:0/SceneTreeDock:0/SceneTreeEditor:0/Tree:0",
		...
		TutorialStep.new("Een scene opslaan (2)", 
			...
			null, Callable(),
			"Panel:0/EditorFileDialog:2/VBoxContainer:0/HSplitContainer:0/VBoxContainer:0/HBoxContainer:1/LineEdit:0",
			_scene_saved),
		TutorialStep.new("Scene bestand", 
			...
			null, Callable(),
			"Panel:0/VBoxContainer:0/HSplitContainer:0/HSplitContainer:0/VSplitContainer:0/TabContainer:1/FileSystemDock:0/VSplitContainer:0/Tree:0"),
		...
		TutorialStep.new("Wisselen tussen scenes",
			...
			null, Callable(),
			"Panel:0/VBoxContainer:0/HSplitContainer:0/HSplitContainer:0/HSplitContainer:0/VBoxContainer:0/VSplitContainer:0/VSplitContainer:0/VBoxContainer:0/PanelContainer:0/HBoxContainer:0/TabBar:0",
