...
func _init(title: String, description: String, illustration: Texture2D = null, enter_script := Callable(), node_to_highlight := "", check_user_completed_action_script:= Callable()):
	_title = title
